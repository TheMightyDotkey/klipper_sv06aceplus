...
#define FAN0_GPIO GPIO('B', 0)
#define FAN1_GPIO GPIO('A', 6)

struct gpio_out fan0;
struct gpio_out fan1;
/****************************************************************
 * Startup
 ****************************************************************/
...
armcm_main(void)
{
    ...
    fan0 = gpio_out_setup(FAN0_GPIO, 0);
    fan1 = gpio_out_setup(FAN1_GPIO, 0);

    gpio_out_write(fan0, 0);
    gpio_out_write(fan1, 0);
